...
int main(int argc,char* argv[])
{
	...
	try{ 
		...
		unsigned int MAX_GEN = parser.createParam((unsigned int)(40), "maxGen", "Maximum number of generations",'G',"Param").value();
		...
		//SPEA2
		moeoSPEA2<SCN> spea2 (MAX_GEN, eval, xover, P_CROSS, mut, P_MUT, arch);
		spea2 (pop);
